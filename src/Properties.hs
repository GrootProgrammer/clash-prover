...
findEquivInDef (Def _ (DirectOperation (DirectOperation (DirectOperation (DirectOperation (Variable equivName) _) _) arg1) arg2)) = [(arg1, arg2) | "$my-prover-0.1.0.0-inplace$Properties$Equiv" `isPrefixOf` show equivName ]
findEquivInDef _ = []